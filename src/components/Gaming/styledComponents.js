...
export const GamingRouteFailureContainer = styled.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  height: 100vh;
  ...
  background-color: ${props => (props.light ? '#f9f9f9' : ' #0f0f0f')};
`
export const GamingRouteFailureImage = styled.img`
  width: 200px;
  height: 200px;
  @media screen and (min-width: 768px) {
    width: 300px;
...
`
export const GamingRouteFailureHeading = styled.h1`
...
export const GamingRouteFailureDescription = styled.p`
  text-align: center;
  color: #64748b;
  font-family: 'Roboto';
  font-size: 14px;
...
export const GamingRouteFailureRetryButton = styled.button`
  font-family: 'Roboto';
  font-weight: 500;
  font-size: 14px;
  padding: 12px 32px;
